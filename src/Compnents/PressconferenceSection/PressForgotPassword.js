...
const PressForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/press/forgot-password', {
        method: 'POST',
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Enter your registered press email to reset password</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Enter your press email"
              value={email}
...
export default PressForgotPassword;