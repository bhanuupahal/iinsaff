    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">Press Conference Registration</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-gray-100">
          <div className="p-8">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-semibold text-gray-900">Press Member Registration</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex flex-col items-center justify-center pt-6 border-t border-gray-200">
                ...
                <p className="mt-4 text-sm text-gray-600">
                  ...
                  <Link to="/press-conference/login" className="text-blue-600 hover:text-blue-700 font-medium">
                    Sign in here
                  </Link>
                </p>
              </div>
