...
const DarbarRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/darbar/register', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-2">
            Welcome to <span className="text-green-600">Janseva</span> Darbar
          </h2>
          <p className="text-lg text-gray-600">Register to connect with our service platform</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-gray-100">
          <div className="p-8">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-semibold text-gray-900">Darbar Registration</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    name="password"
                    required
                    className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500"
              ...
              <div className="flex flex-col items-center justify-center pt-6 border-t border-gray-200">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full md:w-1/2 bg-gradient-to-r from-green-600 to-green-700 text-white px-8 py-3 rounded-lg 
                ...
                <p className="mt-4 text-sm text-gray-600">
                  ...
                  <Link to="/darbar/login" className="text-green-600 hover:text-green-700 font-medium">
                    Sign in here
                  </Link>
                </p>
              </div>
